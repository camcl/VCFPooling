...
Usage example:
(Beagle)
$ python3 -u genotypes_imputed.py /home/camille/PoolImpHuman/data/20200722/IMP.chr20.snps.gt.vcf.gz /home/camille/PoolImpHuman/data/20200722/IMP.chr20.pooled.imputed.vcf.gz /home/camille/PoolImpHuman/results/20200722 beagle

(Phaser)
$ python3 -u genotypes_imputed.py /home/camille/PoolImpHuman/data/20200817/IMP.chr20.snps.gt.vcf.gz /home/camille/PoolImpHuman/data/20200817/IMP.chr20.pooled.imputed.vcf.gz /home/camille/PoolImpHuman/results/20200817 phaser

(Beagle example subset)
VCFPooling/examples$ python3 -u ../python/genotypes_imputed.py ./IMP.chr20.snps.gt.vcf.gz ./IMP.chr20.pooled.imputed.vcf.gz /.
"""
...
true_genos = [0, 1, 2]  # trinary encoding with int, not float
true_labels = ['0/0', '0/1', '1/1']
imputed_genos = [0, 1, 2]  # , -0.5, 0.5, -1.0]  # nothing missing after imputation
imputed_labels = ['0/0', '0/1', '1/1']  # , '0/.', './1', './.']  # nothing missing after imputation
...
for i, bin in enumerate(lab_bins):
        #bin = lab_bins[i]
...
plt.tight_layout()
plt.savefig(os.path.join(outdir, 'true00_genotypes_imputed_scaled_proportions.pdf'))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(outdir, 'true01_genotypes_imputed_scaled_proportions.pdf'))
plt.show()
...
plt.tight_layout()
plt.savefig(os.path.join(outdir, 'true11_genotypes_imputed_scaled_proportions.pdf'))
plt.show()
...
fig.savefig(os.path.join(outdir, '{}_genotypes_imputed_scaled_proportions.pdf'.format(algo)))
