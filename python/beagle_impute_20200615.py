...
To be run from ~/PoolImpHuman/data/20200615

Calling from command-line: 
$ source ~/1000Genomes/venv3.6/bin/activate
$ python3 beagle_impute_20200615.py ~/PoolImpHuman/data/20200615 2
...
path_gt_files = fpath  # prm.PATH_GT_FILES
path_gl_files = fpath  # prm.PATH_GL_FILES
...
#     mkdir(cd)
cd = fpath  # '~/PoolImpHuman/data/20200615'
os.chdir(cd)
