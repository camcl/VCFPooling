...
paths = {'beagle1': {
    ...
    'imputed': '/home/camille/1000Genomes/data/gl/gl_adaptive/chunk10000_20190822/IMP.chr20.pooled.imputed.gt.chunk10000.vcf.gz'},
         'beagle2': {
     'true': '/home/camille/1000Genomes/data/gt/stratified/IMP.chr20.snps.gt.chunk10000.vcf.gz',
     'imputed': '/home/camille/1000Genomes/data/gl/gl_adaptive/single_samples_merged/IMP.chr20.pooled.imputed.gt.chunk10000.vcf.gz'}
}
...
tabbeagle1.plot.scatter('af_info', 'cross_entropy', ax=axes[5, 1], s=0.7, label='beagle1')
