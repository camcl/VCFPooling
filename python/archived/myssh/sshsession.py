...
class SSHSession(object):
    ...
    def run(self, cmd):  # added by me
        channel = self.t.open_channel("session")  # Reopen a new channel for every new command
        channel.exec_command(cmd)  # When the command finishes executing, channel is closed and can’t be reused.
        channel.close()
