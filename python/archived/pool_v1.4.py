...
Running from cmd:
$ python3 pool.py /home/camille/1000Genomes/data/tests-beagle/ALL.chr20.snps.gt.vcf.gz gt False /home/camille/1000Genomes/data/tests-beagle/ALL.chr20.pooled.snps.gt.vcf.gz
"""
...
def init_chunk(chunk=True):
    ...
    splits = split_pools(raw.samples, 16, seed=135)  # list of lists
