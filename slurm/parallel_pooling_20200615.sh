...
echo 'venv activated'
python3 ~/1000Genomes/src/VCFPooling/python/parallel_pooling_20200615.py /crex/proj/snic2019-8-216/20200615/ALL.chr20.snps.gt.chunk10000.vcf.gz /crex/proj/snic2019-8-216/20200615/ALL.chr20.pooled.snps.gl.chunk10000.vcf.gz 20
